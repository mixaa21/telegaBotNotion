...
module.exports = {
    ...
    addNewReport: async function (client, id, title) {       // функция добавления нового отчета
        try {
            await client.query(insert.newTracking(), [id, title])  // вставить в базу данных id юзера и текст сообщения
        } catch (e) {
